...
ALIASES: tuple[AliasSpec, ...] = (
    ...
    AliasSpec("v2.health", "/api/current/intelligence/platform/health", ("GET",), "intelligence"),
    AliasSpec("v2.live", "/api/current/intelligence/live", ("GET",), "intelligence"),
    AliasSpec(
        "v2.team",
    ...
    AliasSpec("analytics_api.injuries", "/api/current/analytics/injury-impact", ("POST",), "analytics"),
    AliasSpec("analytics_api.similarity", "/api/current/analytics/player-similarity", ("POST",), "analytics"),
    AliasSpec("analytics_api.matchup", "/api/current/analytics/matchup", ("POST",), "analytics"),
    AliasSpec("analytics_api.intelligence", "/api/current/analytics/game-intelligence", ("POST",), "analytics"),
    AliasSpec("analytics_api.live_center", "/api/current/analytics/live-center", ("POST",), "analytics"),
    AliasSpec("analytics_api.player_ai", "/api/current/analytics/player-intelligence", ("POST",), "analytics"),
    AliasSpec("analytics_api.team_ai", "/api/current/analytics/team-intelligence", ("POST",), "analytics"),
    AliasSpec("analytics_api.betting_ai", "/api/current/analytics/betting-intelligence", ("POST",), "analytics"),
    ...
    AliasSpec("v32_api.saved_filter", "/api/current/realtime/filters/normalize", ("POST",), "realtime"),
    AliasSpec("v32_api.search", "/api/current/realtime/search", ("POST",), "realtime"),
    # v3.2 persisted profile/model/report completion surface
    AliasSpec("v32_release_api.get_profile", "/api/current/profile", ("GET",), "profile_models_reports"),
    AliasSpec("v32_release_api.put_profile", "/api/current/profile", ("PUT",), "profile_models_reports"),
    AliasSpec("v32_release_api.model_calibration", "/api/current/models/calibration", ("POST",), "profile_models_reports"),
    AliasSpec("v32_release_api.model_backtest", "/api/current/models/backtest", ("POST",), "profile_models_reports"),
    AliasSpec("v32_release_api.model_drift", "/api/current/models/drift", ("POST",), "profile_models_reports"),
    AliasSpec("v32_release_api.provider_freshness", "/api/current/providers/freshness", ("POST",), "profile_models_reports"),
    ...
    AliasSpec("v45_api.get_dead_letters", "/api/current/deliveries/dead-letters", ("GET",), "deliveries"),
    AliasSpec("v45_api.get_delivery_metrics", "/api/current/deliveries/metrics", ("GET",), "deliveries"),
    AliasSpec(
    ...
    AliasSpec("v45_api.get_delivery", "/api/current/deliveries/<delivery_id>", ("GET",), "deliveries"),
)
